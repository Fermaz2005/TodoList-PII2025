...
namespace TodoList
{
    public partial class Form1 : Form
    {
        ...
        public void onBtnBuscarClick(object sender, EventArgs e)
        {
            string textoBusqueda = txtBoxBuscar.Text.ToLower().Trim();
            ...
            var tareasFiltradas = tareas
                .Where(t => t.Nombre.ToLower().Contains(textoBusqueda))
                .ToList();
